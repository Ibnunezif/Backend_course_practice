...
app.post("/submit", (req, res) => {
  ...
  //Then:
  var randomNumberForNoun=Math.floor((Math.random())*adj.length);
  var randomNumberForAdj=Math.floor((Math.random())*adj.length);
  const adjective=adj[randomNumberForAdj];
  const nounItem =noun[randomNumberForNoun];
  ...
  res.render ("index.ejs",{adjective,nounItem});
